...
ActiveRecord::Schema[7.1].define(version: 2026_05_11_192405) do
  ...
  create_table "holidays", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "reports", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["em_rut"], name: "index_reports_on_em_rut"
  ...
  create_table "rules_plats", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "code"
    t.string "point"
    t.string "ref"
    t.string "level"
